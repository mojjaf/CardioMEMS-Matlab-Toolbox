...
[alltraces_ax,avpeak_accx,~] = averagedpeaks_ECG_REF(accX,fs_lsm,3, ploc_ECG);
[alltraces_ay,avpeak_accy,~] = averagedpeaks_ECG_REF(accY,fs_lsm,3, ploc_ECG);
[alltraces_az,avpeak_accz,~] = averagedpeaks_ECG_REF(accZ,fs_lsm,3, ploc_ECG);
[alltraces_gx,avpeak_gyrx,~] = averagedpeaks_ECG_REF(gyroX,fs_lsm,3, ploc_ECG);
[alltraces_gy,avpeak_gyry,~] = averagedpeaks_ECG_REF(gyroY,fs_lsm,3, ploc_ECG);
[alltraces_gz,avpeak_gyrz,~] = averagedpeaks_ECG_REF(gyroZ,fs_lsm,3, ploc_ECG);
...
[alltraces_axHF,avpeak_accxHF,~] = averagedpeaks_ECG_REF(accX_hf,fs_adxl,3, ploc_ECGHF);
[alltraces_ayHF,avpeak_accyHF,~] = averagedpeaks_ECG_REF(accY_hf,fs_adxl,3, ploc_ECGHF);
[alltraces_azHF,avpeak_acczHF,~] = averagedpeaks_ECG_REF(accZ_hf,fs_adxl,3, ploc_ECGHF);
[alltraces_axLF,avpeak_accxLF,~] = averagedpeaks_ECG_REF(accX_lf,fs_adxl,3, ploc_ECGHF);
[alltraces_ayLF,avpeak_accyLF,~] = averagedpeaks_ECG_REF(accY_lf,fs_adxl,3, ploc_ECGHF);
[alltraces_azLF,avpeak_acczLF,~] = averagedpeaks_ECG_REF(accZ_lf,fs_adxl,3, ploc_ECGHF);
