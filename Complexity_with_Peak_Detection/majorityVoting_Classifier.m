function[results,missclassfied] = majorityVoting_Classifier(xTrain,yTrain,ids,pca_flag)
...
yTrain(trainIdx), 'Bag', 400, 'Tree', 'Type', 'Classification');
...
%     'NumLearningCycles',100,'Learners','Tree','RobustErrorGoal',0.05, ...
%     'RobustMaxMargin',1);
