...
subID=[];
            ...
            % %             NSTEMI + STEMI
%             hfiles = 'D:\BIOSIGNAL_PROCESSING\MI Detect project\STEMI_Mechanical Complexity\DATA_CLEANED_04092018\NEW CLEANED _ 15012019\STEMI_HQekg_noAF/'; %% OLD Filtering 3-50Hz
            %             NSTEMI data
...
%      for k=1:1
        ...
        fprintf('Loading patient number ...= %0.3f\n', k); 
    ...
    if data.data_cleaned.info.USABLE_ECG    
        ...
        ekg_lf=fft_filter(data.data_cleaned.ekg(1:jitter*fs_lsm),fs_lsm,1,49);
...
%          continue
        ...
        win=15;
        step=7.5;
        Is_MI=data.data_cleaned.info.STEMI_TYPE;
...
%%%%%%%%%%%%%%%%%%%%%%
[results,missclassfied]= majorityVoting_SAFE(Xtrain_sys,all_labels,Subjects_IDs,0);
